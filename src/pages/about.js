...
const AboutPage = ({ ...props }) => {
  ...
  return (
    <>
      ...
      <Section
        className="bg-palette-100 desktop:bg-white desktop:bg-column"
        marginBottom={false}
        first={true}
      >
        <div className="grid grid-cols-1 gap-x-16 gap-y-16 desktop:grid-cols-3">
          <div className="col-span-3">
            <h1>
              ...
              <span className="text-primary underline-dark">
          ...
          <div className="col-span-3 desktop:col-start-2 desktop:col-span-2 space-y-12">
            <p className="text-palette-600 font-light text-lg">
              Skynet is an open protocol and toolkit for creating a better web —
              one built on decentralized storage and applications.
            </p>

            <p className="font-content text-palette-400">
              Skynet apps transform what’s possible on the web. Beyond
              protecting privacy, decentralization enables application,
              integration, and innovation that simply cannot be replicated by
              the centralized world. Now, we can break free of the walled
              gardens and data silos that have constricted invention and
              interoperability. Key features of decentralization such as
              user-owned personal data, persistent identity across apps, and
              censorship-resistance will be the new standards of the digital
              world.
            </p>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <div className="mt-14 text-center space-y-6">
              <p className="font-light text-lg text-palette-600">
                Want to build apps with these features?
              </p>
              <Link
                to="/developers"
                className="button-secondary-dark inline-block px-10"
              >
                Get started here
              </Link>
            </div>
      ...
      <Section className="background bg-top bg-cover">
        <SectionTitle className="text-white">
          ...
          <span className="text-primary underline-white">
            decentralized internet
          </span>
        </SectionTitle>
        ...
        <div className="grid grid-cols-1 gap-x-16 gap-y-16 desktop:grid-cols-3 mt-10">
          <div
            ...
            style={{
              background:
                'url(/logo-symbol.svg) no-repeat left center / contain',
            }}
          ></div>

          <div className="col-span-3 desktop:col-start-2 desktop:col-span-2 space-y-12">
            <p className="text-white font-light text-lg">
              Skynet Labs is the core contributor to Skynet, an application
              development and hosting platform built on Sia, the leading
              decentralized cloud storage network.
            </p>

            <p className="font-content text-palette-300">
              Skynet is more than the members of the Skynet Labs team. We are a
              community and movement of global citizens who believe in the
              positive power of decentralized technology for humanity. No one
              person or organization should censor or deny access to data — not
              miners, not developers, nor any government. Through our
              technology, we seek to build a better and more equitable internet
              ecosystem. Users, developers, and content creators deserve to be
              in full control of their data, not monopolistic corporations.
            </p>
            ...
            <p className="font-content text-palette-300">
              Our commitment to decentralization is at our core. With this ethos
              in mind, we believe in empowering local leaders to decide what is
              best for their communities in adoption of this technology.
              Individuals and communities deserve self-determination.
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section className="bg-white">
        <div className="space-y-10 desktop:space-y-20 flex flex-col">
          <div>
            ...
            <SectionTitle>
              Skynet stands with you in the fight for a free future
            </SectionTitle>
          </div>
          ...
          {showCareersCTA && (
            <div className="desktop:col-span-2 flex flex-col desktop:flex-row items-center desktop:space-x-8 space-y-8 desktop:space-y-0">
              <Link
                className="flex-shrink-0 hidden desktop:inline-block"
                {...careers}
              >
                <Join />
              </Link>
              <p className="font-light text-lg text-center desktop:text-left">
                Join us! We're looking for talented &amp; passionate individuals
                to join our team. Check out our job postings today.
              </p>
