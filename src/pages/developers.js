...
const resources = [
  ...
  },
  {
    ...
    description:
      'Includes SDKs, resources, and web portal. PR’s always welcome.',
    href: 'https://github.com/SkynetLabs',
  },
  {
    title: 'Join us on Discord',
    description:
      'A generous developer community, ready to solve hard problems.',
            ...
            {docs.map(({ name, href }, index) => (
              <li key={index}>
                ...
                >
                  {name}{' '}
                  <ExternalLink
                    className="fill-current inline-block ml-2"
                    height={28}
                  />
                </Link>
              </li>
      ...
      <div className="grid grid-cols-1 desktop:gap-x-8 gap-y-10 desktop:grid-cols-3">
        <div className="space-y-8">
          ...
          <p className="font-light text-lg">
            Whether hosting your front-end or building a full-scale web app,
            start here.
          </p>
        </div>
          ...
          {resources.map(({ href, title, description }, index) => (
            <li key={index}>
              ...
              >
                ...
                <div className="font-content text-palette-400">
                  {description}
                </div>
              </Link>
            </li>
